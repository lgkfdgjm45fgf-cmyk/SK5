...
do
    ...
    echo "ddvpn     l2tpd     dd123     192.168.18.$start_num" >> /etc/ppp/chap-secrets
    ...
    echo "ip地址  $ip  用户名 ddvpn 密码  dd123  预共享秘钥  $psk  对应外网ip  $public_ip" >> ./l2tp.txt
